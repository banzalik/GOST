    ...
    config.nodes(['pages/*'], function(nodeConfig) {
        ...
        if (nodeConfig._path === 'pages/common') {
            nodeConfig.addTechs([
                ...
                new (require('enb/techs/deps-provider'))({sourceNodePath: 'pages/documentation', sourceTarget: 'documentation.deps.js'}),
            ...
            nodeConfig.addTechs([
                new (require('enb-borschik/techs/borschik'))({ sourceTarget: '?.raw.js', destTarget: '?.bemjson.js', minify: false }),
